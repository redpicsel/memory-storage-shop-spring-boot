...
<head>
  ...
  <title>Memory Storage Shop | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="${pageContext.request.contextPath }/resources/admin/index2.html"><b>Memorys</b>Shop</a>
  </div>
  ${msg }
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Welcome to Memory Storage Shop!</p>
    ...
    <a href="${pageContext.request.contextPath }/account/register" class="text-center">Register a new membership</a>
